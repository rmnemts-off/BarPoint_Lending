...
(function () {
  ...
  if (!reduceMotion && hasGsap) {
    ...
    /* ============================================================
       ...
       У нас их было семь (с правкой 07.08 — четыре), и на седьмом шаге
       верх ряда ушёл бы на 64·6 = 384px вниз — вместе с высотой ряда это
       950px, то есть ниже кромки экрана, и хвост списка обрезало бы.
       Ограничитель нужен и на четырёх: 64·3 = 192 плюс ряд в 680 дают
       872 при экране 900. Поэтому нарастание ограничено сверху
