...
window.BARPOINT_CASES = [
  ...
  },
  {
    ...
    /* Кадры 06.08 (третий заход, присланы в чате): интерьер лофта с
       ...
       ОГОВОРКА ПО КАЧЕСТВУ: исходники 2, 3 и 4 маленькие (682×1024 и
       1000×667). Коробка разворота на retina просит 1467×1680, то есть
       эти кадры дают 40–61% нужного разрешения и на большом экране будут
       мылить. Если у заказчика есть оригиналы крупнее — переэкспортировать. */
    cardImage: "case-duran-cover-1200",
    gallery: ["case-duran-1-1100", "case-duran-2-682", "case-duran-3-914", "case-duran-4-1000"]
  },
  {
