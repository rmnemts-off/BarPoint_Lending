...
window.BARPOINT_CASES = [
  {
    ...
    fullDescription: "Ресторан, в котором кулинарные традиции России от Камчатки до Дагестана соединены в изысканную палитру вкусов. Каждая деталь ресторана на Остоженке наполнена смыслами, отсылающими к древним культурам и обычаям народов России. Барная карта отражает глубину культурных кодов и национальных обрядов, превращая напиток в послание о наследии.",
    works: [
  ...
  },
  {
    ...
    fullDescription: "Камерный бар, скрытый в зале стихии воды ресторана Aina. Каждый коктейль — ритуал, вдохновлённый мифами и традициями народов России: за каждым напитком стоит история одного из обрядов, а в рецептах используются ингредиенты, характерные тем или иным регионам страны. Аутентичные ингредиенты соединены в утончённый рассказ о культуре.",
    works: [
  ...
  },
  {
    ...
    fullDescription: "Ресторан, где оживает эстетика России 1920-х — периода столкновения двух культурных кодов. Барная карта строится на поэзии эпохи: официанты читают стихи, которые вдохновили авторов коктейлей, настоек и дистиллятов. Атмосфера — театральная, яркая, авангардная.",
    works: [
  ...
  },
  {
    ...
    fullDescription: "Открыт совместно с проектом BURO 24/7. Ежегодно команда BARPOINT представляет коллаборации: коктейльные карты, посвящённые premium-брендам (Cartier, Dior, Bulgari), «Карта Pantone» — коктейли, посвящённые известным российским дизайнерам, и специальные карты к Неделям моды в Москве.",
    works: [
  ...
  },
  {
    ...
    fullDescription: "Игровой лаунж премиум-класса с беспрецедентным уровнем комфорта, сервиса, оборудования и аудитории. Коктейли подаются в тематических кастомных бокалах, созданных под персонажей игровых вселенных, — напиток становится частью игрового мира.",
    works: [
  ...
  },
  {
    ...
    fullDescription: "Marcelo Miracles Shop & Bar — модный коктейльный бар и бутик. Проект дизайнера Марка Родовского объединяет гастрономию и концепцию фирменного магазина одежды. Центральное место в барной карте занимают сезонные авторские коктейли, включая миксы на кранах.",
    works: [
  ...
  },
  {
    ...
    fullDescription: "LEPS Asian Restaurant & Singer Club — паназиатский премиум-ресторан. Проект Григория Лепса и ресторатора Ильи Эстерова (Memo, Duran Bar) объединяет высокую гастрономию, безупречную барную классику, музыку и атмосферу ночной жизни. В первой половине вечера гостей ждут блюда паназиатской кухни и аутентичные напитки в азиатском стиле.",
    works: [
  ...
  },
  {
    ...
    fullDescription: "Пространство вдохновлено маршрутами, по которым веками двигались караваны — с чаем и кофе, специями, фруктами, орехами и цветами. Каждый раздел барной карты — часть этого пути: в ней пересекаются торговые дороги, где встречаются эстетика Запада и шарм Ближнего Востока.",
    works: [
  ...
  },
  {
    ...
    fullDescription: "Международный бренд напитков. Мы стояли у истоков PIMS: бренд создан при нашем участии и вырос вместе с нами — команда увеличила оборот от 2 млн до 5 млрд. Адаптация под рынок, климат и вкусы гостей; в основе — тренды, виральность, технологичность.",
